...
namespace  EnemyManager
{
	...
	public:
		...
		int appearCnt;							//出現カウンタ
		vector<BResource::SP> residentResource;	//リソース常駐配列

		bool isAppearBoss;						//ボスが出現したか？
		void AppearEnemy(int enemyNum_);		//敵出現関数

		enum class Mode {
			AppearNormalEnemy,	// 通常敵出現
			CoolTimeUpToBoss,	// ボス出現までのクールタイム
			BossAction,			// ボス行動
			EnemyAnnihilation,	// 敵全滅
		} mode;
